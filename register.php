        ...
        if(empty(trim($_POST["email"]))){
            ...
            if($stmt = mysqli_prepare($link, $sql)){
                ...
                if(mysqli_stmt_execute($stmt)){
                    ...
                    if(mysqli_stmt_num_rows($stmt) == 1){
                        $email_err = "L'adresse email est déjà utilisée.";
                    } else{
                        $email = trim($_POST["email"]);
                    }
                } else{
                    echo "Oops! Il y a eu une erreur. Merci de réessayer plus tard.";
                }
...
<body>
    <div class="form--position_center">
        <div class="wrapper">
            <h2>Inscription</h2>
            <p>Merci de renseigner les champs pour vous inscrire.</p>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="reset" class="btn btn-secondary ml-2" value="Réinitialisation">
                </div>
                <p>Vous avez déjà un compte ? <a href="login.php">Connection ici</a>.</p>
            </form>
        </div>
    </div>    
</body>
